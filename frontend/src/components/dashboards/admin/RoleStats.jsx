...
const RoleStats = ({ stats, loading, onCreateClick }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      {/* Custom Roles */}
      <div 
        className={`bg-white dark:bg-slate-800 rounded-lg p-4 border border-gray-200 dark:border-slate-700 ${onCreateClick ? 'cursor-pointer hover:border-green-300 dark:hover:border-green-700 hover:shadow-md transition-all duration-200 group' : ''}`}
